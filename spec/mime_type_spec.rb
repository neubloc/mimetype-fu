...
require File.dirname(__FILE__) + '/../lib/mimetype-fu'
...
describe 'An open file' do
  ...
  describe 'with spaces in name' do
    before do
      write_file('file with spaces.png', "\211PNG\r\n\032\n", 'wb')
    end
  ...
  describe 'with an unknown extension' do
    before do
      write_file('file.unknown', "\211Random\r\n\032\n", 'wb')
    end
